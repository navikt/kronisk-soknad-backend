...
private fun envOrEmpty(envVar: String) = System.getenv()[envVar] ?: ""


fun producerConfig() = mutableMapOf<String, Any>(
    ProducerConfig.BOOTSTRAP_SERVERS_CONFIG to envOrEmpty("KAFKA_BROKERS"),
    ...
    SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG to envOrEmpty("KAFKA_TRUSTSTORE_PATH"),
    SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG to envOrEmpty("KAFKA_CREDSTORE_PASSWORD"),
    SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG to envOrEmpty("KAFKA_KEYSTORE_PATH"),
    SslConfigs.SSL_KEYSTORE_PASSWORD_CONFIG to envOrEmpty("KAFKA_CREDSTORE_PASSWORD"),
    SslConfigs.SSL_KEY_PASSWORD_CONFIG to envOrEmpty("KAFKA_CREDSTORE_PASSWORD")
)
