...
fun localConfig(env: Env.Local): Module = module {
    ...
    single { GravidKravEndreProcessor(get(), get(), get(), get(), GravidKravPDFGenerator(), get(), get(), get()) }
    ...
    single { KroniskKravEndreProcessor(get(), get(), get(), get(), KroniskKravPDFGenerator(), get(), get(),get()) }
