        ...
        exception<JsonMappingException> { call, cause ->
            when (cause.cause) {
                is ConstraintViolationException ->
                    ...
                    handleJsonException(call, cause)
            }
        }
...
private suspend fun handleBadRequestException(call: ApplicationCall, cause: BadRequestException) {
    when (cause.cause) {
        ...
        is JsonParseException ->
            handleJsonException(call, cause.cause as JsonParseException)
        is InvalidFormatException ->
            handleJsonException(call, cause.cause as InvalidFormatException)
...
private suspend fun <T : Throwable> handleJsonException(call: ApplicationCall, cause: T) {
...
private suspend fun <T : Throwable> ApplicationCall.respondProblem(
    ...
    respond(httpStatusCode, problem)
}
