    ...
    val gravidKravRequestWithWrongDecimal = GravidKravRequest(
        ...
        perioder = listOf(
            ArbeidsgiverperiodeNy(
                ...
                .also {
                    it.felter = AgpFelter(antallDagerMedRefusjon = 5, månedsinntekt = 12344.0)
                }
        ),
    ...
    val gravidKravRequestValidPeriode1Dag = GravidKravRequest(
        ...
        perioder = listOf(
            ArbeidsgiverperiodeNy(
                ...
                .also {
                    it.felter = AgpFelter(antallDagerMedRefusjon = 1, månedsinntekt = 123.8)
                }
        ),
    ...
    val gravidKrav = GravidKrav(
        ...
        perioder = listOf(
            ArbeidsgiverperiodeNy(
                ...
                .also {
                    it.felter = AgpFelter(5, månedsinntekt = 2590.8)
                }
        ),
        kontrollDager = null,
        antallDager = 4,
